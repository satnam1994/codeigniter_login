        ...
        <?= form_hidden('user_id', $this->session->userdata('id') ); ?>
          <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-9">
                <?= form_input(['type' => 'text', 'id' => 'articleTitle', 'name' => 'title', 'placeholder' => 'Enter Article Title Here...', 'class' => 'form-control', 'value' => set_value('title', $article->title)]); ?>
                <?php
                  if(form_error('title')) {
          ...
          <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-9">
                <?= form_textarea(['type' => 'textarea', 'id' => 'articleBody', 'name' => 'body', 'placeholder' => 'Enter Article Body Here...', 'class' => 'form-control', 'value' => set_value('title', $article->body)]); ?>
                <?php
                  if(form_error('body')) {
